...
- (void)setupBarButtonItem
{
    ...
    [backButton setImage:[UIImage imageNamed:@"message_system"] forState:UIControlStateNormal];
    [backButton addTarget:self action:@selector(systemMessageAction) forControlEvents:UIControlEventTouchUpInside];
...
{
    PatientSystemMessagesViewController *vc = [[PatientSystemMessagesViewController alloc]init];
    [self.navigationController pushViewController:vc animated:YES];
    //[self push:@"MessageHomeViewController" isNib:YES];
}
